...
rl=try(rlm(y,lambda=0.1,kmax,cmax=1,B=10))
res$rl10=rl

rl=try(rlm(y,lambda=0.1,kmax,cmax=1,B=50))
res$rl50=rl

rl=try(rlm(y,lambda=0.1,kmax,cmax=1,B=100))
res$rl100=rl

rl=try(rlm(y,lambda=0.1,kmax,cmax=1,B=200))
res$rl200=rl

rl=try(rlm(y,lambda=0.1,kmax,cmax=1,B=500))
res$rl500=rl
...
save(res,file=paste0("B",pers,".rda",sep=""))
