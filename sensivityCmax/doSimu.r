...
rl=try(rlm(y,lambda=0.1,kmax,cmax=2))
res$rl2=rl

rl=try(rlm(y,lambda=0.1,kmax,cmax=10))
res$rl10=rl

rl=try(rlm(y,lambda=0.1,kmax,cmax=25))
res$rl25=rl

rl=try(rlm(y,lambda=0.1,kmax,cmax=50))
res$rl50=rl
...
save(res,file=paste0("Cmax",pers,".rda",sep=""))
